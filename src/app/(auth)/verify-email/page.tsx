...
import { AuthService } from "@/app/_shared/services/AuthService"; // Import the centralized service
...
const VerifyEmailForm = () => {
  ...
  if (!email) {
    return (
      <main className="min-h-[calc(10vh-4rem)] bg-slate-100 pt-24 px-4 w-full">
...
// This is the main page component that wraps the form in Suspense
